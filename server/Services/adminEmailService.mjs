...
export const sendAdminOTPEmail = async (email, otp) => {
  const mailOptions = {
    ...
    to: email,
    subject: '🔐 Admin Panel - Email Verification Code',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <div style="padding: 40px 30px;">
            <div style="text-align: center; margin-bottom: 30px;">
              ...
              <p style="color: #6b7280; margin: 0; font-size: 16px; line-height: 1.5;">
                Welcome to the FitZone Admin Panel! Please verify your administrator email address to complete your registration.
              </p>
            </div>
          ...
          <div style="background: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; margin: 0 0 10px 0; font-size: 14px;">
              <strong>FitZone Admin Panel</strong><br>
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <div style="padding: 40px 30px;">
            <div style="text-align: center; margin-bottom: 30px;">
              ...
              <p style="color: #6b7280; margin: 0; font-size: 16px; line-height: 1.5;">
                A password reset has been requested for your FitZone administrator account. Use the code below to reset your password.
              </p>
            </div>
            ...
            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; border-radius: 0 8px 8px 0; margin: 30px 0;">
              ...
              <ul style="color: #92400e; margin: 0; padding-left: 20px; font-size: 14px; line-height: 1.6;">
                ...
                <li>Admin access controls the entire fitness system</li>
